#!/usr/bin/env python3
"""
Синхронная система планирования анонсов игр
"""
...
class GameAnnouncementSchedulerSync:
    """Синхронный планировщик анонсов игр"""
...
announcement_scheduler = GameAnnouncementSchedulerSync()

async def main():
    """Основная функция"""
    print("🏀 СИНХРОННЫЙ ПЛАНИРОВЩИК АНОНСОВ ИГР")
    print("=" * 60)
